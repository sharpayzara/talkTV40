...
import com.sumavision.talktv4.dao.DatabaseHelper;
...
public class OrmLiteDao<T> {
    ...
    public boolean deleteByColumnName(String columnName, Object value) {
        ...
        try {
            ...
            JLog.w("delete error, columnName: " + columnName + ", value: " + value + ", result: " + result, e.toString());
            return false;
        }
        return result > 0;
    }
    ...
    public boolean deleteByColumnName(Map<String, Object> map) {
        ...
        try {
            ...
            JLog.w("delete error,delete line:" + result, e.toString());
            return false;
        }
        return result > 0;
    }
    ...
    public boolean updateBy(T t, Map<String, Object> value) {
        ...
        try {
            ...
            JLog.e("update error,update line:" + result, e);
        } catch (NoSuchFieldException e) {
            JLog.e("update error,update line:" + result, e);
        } catch (SQLException e) {
            JLog.e("update error,update line:" + result, e);
