 ...
 */
public class GanHuoFragmentFragment extends BaseFragment<GanHuoFragmentPresenter> implements IGanHuoFragmentView,
    ...
    public GanHuoFragmentFragment() {
    }

    public static GanHuoFragmentFragment newInstance(String type) {
        GanHuoFragmentFragment fragment = new GanHuoFragmentFragment();
